...
CREATE TABLE IF NOT EXISTS trainer(
    ...
    TrainerName VARCHAR(MAX) NOT NULL,
...
CREATE TABLE IF NOT EXISTS sectionMaterial(
    ...
    MaterialContent VARCHAR(MAX) NOT NULL,
    PRIMARY KEY (CourseID, ClassID, SectionID, MaterialID),
...
CREATE TABLE IF NOT EXISTS quiz(
    ...
    PRIMARY KEY (CourseID, ClassID, SectionID, QuizID),
    FOREIGN KEY (CourseID) REFERENCES Section(CourseID),
    FOREIGN KEY (ClassID) REFERENCES Section(ClassID),
    FOREIGN KEY (SectionID) REFERENCES Section(SectionID)
)
...
CREATE TABLE IF NOT EXISTS question(
    ...
    PRIMARY KEY (CourseID, ClassID, SectionID, QuizID, QuestionID),
...
CREATE TABLE IF NOT EXISTS questionAnswer(
    ...
    AnswerContent VARCHAR(MAX) NOT NULL,
    Correct? BOOLEAN NOT NULL,
    PRIMARY KEY (CourseID, ClassID, SectionID, QuizID, QuestionID, AnswerID),
