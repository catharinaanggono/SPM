...
class TestApp(flask_testing.TestCase):
    app.config['SQLALCHEMY_DATABASE_URI'] = "mysql+mysqlconnector://root:4ordX9IZBFbU@3.140.60.132/one_stop_lms_testing"
    ...
    def setUp(self):
        ...
        self.engine = sqlalchemy.create_engine("mysql+mysqlconnector://root:4ordX9IZBFbU@3.140.60.132") # connect to server
        self.engine.execute("""
